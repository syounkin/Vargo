...
Here we use the functions written by Tewdard to parse the property file.
...
What version of R and R packages were used?  See below.

```{r session}
sessionInfo()
```

```{r test3, error = FALSE, warning = FALSE, echo = FALSE, eval = FALSE}
